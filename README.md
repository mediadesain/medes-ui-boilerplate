...
- Update Major Changes to version 2 and create some new packages name are `@mediadesain/core`, `@mediadesain/angular`, `@mediadesain/react`.
- Script model, types, helper, service, utils & styling on `@medes-ui@1.x.x.x` are copied to @mediadesain/angular. To install run `npm i @mediadesain/core`.
