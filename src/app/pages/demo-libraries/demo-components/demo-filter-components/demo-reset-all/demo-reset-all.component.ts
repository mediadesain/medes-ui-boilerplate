...
export class DemoResetAllComponent {
  ...
  tableContent = [
    {docType: 'angular', attribute: 'model', type: 'MdsFilterModel', default: '∞', description: 'Custom configuration parameter', version: '@medes-ui/angular@2.0.0 > Latest version'},
    {docType: 'angular', attribute: 'customClass?', type: 'string', default: '∞', description: 'Classes list for component itself', version: '@medes-ui/angular@2.0.0 > Latest version'},
    {docType: 'react', attribute: 'model', type: 'MdsFilterModel', default: '∞', description: 'Custom configuration parameter', version: '@medes-ui/react@2.0.0 > Latest version'},
    ...
    {docType: 'react', attribute: 'customClass?', type: 'string', default: '∞', description: 'Classes list for component itself', version: '@medes-ui/react@2.0.0 > Latest version'}
  ]
