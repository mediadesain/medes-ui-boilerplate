...
export class ArrayUtilsComponent {
  ...
  tableContent = [
    {attribute: 'countUniqueValues( <b>Array</b> )', 'value':'Array&lt;string&gt;', 'default': '∞', description: 'Count unique value inside string of array', version: '@medes-ui/core@2.0.0 > Latest version'},
    {attribute: 'sumValues( <b>Array</b> )', 'value':'Array&lt;number&gt;', 'default': '∞', description: 'Sum all number inside of array', version: '@medes-ui/core@2.0.0 > Latest version'},
    {attribute: 'filterMultiple( <b>Array</b>, <b>string</b>, <b>Array</b> )', 'value':'<ul><li>Array</li><li>string</li><li>Array&lt;string&gt;</li></ul>', 'default': '<ul><li>∞</li><li>∞</li><li>∞</li></ul>',description: '<ul><li>Sample data list</li><li>String of Key/prop to show on filter list</li><li>Values will show base on key/prop</li></ul>', version: '@medes-ui/core@2.0.0 > Latest version'},
    {attribute: 'groupValues( <b>Array</b>, <b>string</b> )', 'value':'<ul><li>Array</li><li>string</li></ul>', 'default': '<ul><li>∞</li><li>∞</li></ul>', description: '<ul><li>Sample data list</li><li>String of Key/prop to make it as key</li></ul>', version: '@medes-ui/core@2.0.0 > Latest version'},
    {attribute: 'arrayTolistObject( <b>Array</b>, <b>string</b> )', 'value':'<ul><li>Array</li><li>string</li></ul>', 'default': '<ul><li>∞</li><li>∞</li></ul>', description: '<ul><li>Sample data list</li><li>String of Key/prop to make it as Object Key</li></ul>', version: '@medes-ui/core@2.0.0 > Latest version'},
    {
...
import = `
import { MdsArrayUtils } from '@medes-ui/core';`;
demo = `
